...
/**
 * Fetches mechanics data from Firebase and passes it to a callback function.
 * @param {function} callback - A function to handle the retrieved mechanics data.
 */
export function getMechanics(callback) {
  // Create a reference to the "mechanics" node in the database
  const mechanicsRef = ref(database, "mechanics");

  // Listen for changes in the "mechanics" node
